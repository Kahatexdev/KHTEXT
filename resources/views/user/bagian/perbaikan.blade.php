        ...
        <div class="px-6 py-4">
            <form action="">
                ...
                <div class="grid grid-cols-2 gap-2">
                    ...
                    <div>
                        <label for="keterangan_erp" class="block text-sm font-medium text-gray-700 mb-1">Keterangan In</label>
                    ...
                    <div>
                        <label for="keterangan_smv" class="block text-sm font-medium text-gray-700 mb-1">Keterangan Out</label>
