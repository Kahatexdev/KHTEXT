...
<aside
    ...
    <div class="grow basis-full h-full overflow-y-auto px-4">
        <ul class="flex flex-col pl-0 mb-0">
                                ...
                                @switch($item)
                                    @case('area')
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <path
                                                d="M475.1 163.8L336 252.3v-68.3c0-18.9-20.9-30.4-36.9-20.2L160 252.3V56c0-13.3-10.7-24-24-24H24C10.7 32 0 42.7 0 56v400c0 13.3 10.7 24 24 24h464c13.3 0 24-10.7 24-24V184c0-18.9-20.9-30.4-36.9-20.2z" />
                                        </svg>
                                    @break
                                    ...
                                    @case('kategori_kronologi')
                                        ...
                                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none"
                                            ...
                                            <path d="M16.5 9H7.5" stroke="#000000" stroke-width="2" stroke-linecap="round"
                                                stroke-linejoin="round" />
                                            <path d="M16.5 12H7.5" stroke="#000000" stroke-width="2" stroke-linecap="round"
                                                stroke-linejoin="round" />
                                            <path d="M16.5 15H7.5" stroke="#000000" stroke-width="2" stroke-linecap="round"
                                                stroke-linejoin="round" />
                                        </svg>
                                    @break
                                    ...
                                    @case('masterproses')
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <path
                                                d="M448 73.1v45.7C448 159.1 347.7 192 224 192S0 159.1 0 118.9V73.1C0 32.9 100.3 0 224 0s224 32.9 224 73.1zM448 176v102.9C448 319.1 347.7 352 224 352S0 319.1 0 278.9V176c48.1 33.1 136.2 48.6 224 48.6S399.9 209.1 448 176zm0 160v102.9C448 479.1 347.7 512 224 512S0 479.1 0 438.9V336c48.1 33.1 136.2 48.6 224 48.6S399.9 369.1 448 336z" />
                                        </svg>
                                    @break
            ...
            @foreach ([['name' => 'absen', 'label' => 'Absen'], ['name' => 'flowproses', 'label' => 'Flow Proses'], ['name' => 'kronologi', 'label' => 'Kronologi']] as $menu)
                @php
                          ...
                          {{ $isActive ? 'bg-gradient-to-tl from-info-700 to-cyan-500' : 'bg-white' }}">
                            ...
                            @switch($menu['name'])
                                ...
                                @case('kronologi')
                                    ...
                                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none"
                                        ...
                                        <circle cx="12" cy="12" r="9" stroke="#000000" stroke-width="2"
                                            fill="none" />
                                        <path d="M12 7V12L15 15" stroke="#000000" stroke-width="2" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                    </svg>
                                @break
                                ...
                                @case('pengumuman')
                                    {{-- ICON PENGUMUMAN --}}
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-slate-600" fill="none"
                                        viewBox="0 0 24 24" width="18" height="18" viewBox="0 0 24 24"
            ...
            @if ($role === 'monitoring')
                ...
                <li>
                    <a href="{{ route($routeName) }}"
                        ...
                        <span class="ml-1">Pengumuman</span>
                    </a>
                </li>
            @endif
        </ul>
