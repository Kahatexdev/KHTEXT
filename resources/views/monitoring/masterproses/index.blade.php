...
<div class="w-full px-2 sm:px-4 py-4 sm:py-6 mx-auto space-y-4 sm:space-y-6">
    ...
    <div
        ...
        <div class="min-h-screen flex items-center justify-center p-2 sm:p-4">
            <div class="bg-white rounded-lg shadow-xl w-full max-w-6xl max-h-[90vh] overflow-hidden transform transition-all duration-300 scale-95 opacity-0" id="createModalContent">
                <!-- Modal Header -->
                <div class="flex justify-between items-center px-4 sm:px-6 py-4 border-b bg-white sticky top-0 z-10">
                    ...
                    <button id="closeCreateModal" class="text-gray-400 hover:text-gray-600 text-2xl leading-none p-1 rounded-full hover:bg-gray-100 transition-colors">
                        &times;
                    </button>
                </div>
                                ...
                                <div class="overflow-x-auto">
                                    <table class="min-w-full border text-sm">
                                        ...
                                        <tbody class="text-gray-700">
                                            ...
                                            @foreach($fields as $f)
                                            <tr>
                                                <td class="border px-2 py-2 whitespace-nowrap font-medium">{{ $f }}</td>
                            ...
                            <div class="lg:hidden space-y-4">
                                ...
                                <div class="bg-gray-50 rounded-lg p-4 space-y-3">
                                    ...
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                        <div>
                                            <label class="block text-xs font-medium text-red-600 mb-1">Data Salah</label>
                                            <input type="text" name="salah[{{ Str::slug($f,'_') }}]"
                                                class="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500">
                                        </div>
                                        <div>
                                            <label class="block text-xs font-medium text-green-600 mb-1">Data Benar</label>
                                            <input type="text" name="benar[{{ Str::slug($f,'_') }}]"
                                                class="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500">
                                        </div>
                                    </div>
                ...
                <!-- Modal Footer -->
                <div class="flex flex-col sm:flex-row justify-end space-y-2 sm:space-y-0 sm:space-x-2 px-4 sm:px-6 py-4 border-t bg-gray-50">
                    <button type="button"
    ...
    <!-- Edit Modal -->
    <div
        id="editKronologiModal"
        class="fixed inset-0 z-[9999] hidden overflow-y-auto bg-black bg-opacity-50 transition-opacity duration-300">
        <div class="min-h-screen flex items-center justify-center p-2 sm:p-4">
            <div class="bg-white rounded-lg shadow-xl w-full max-w-6xl max-h-[90vh] overflow-hidden transform transition-all duration-300 scale-95 opacity-0" id="editModalContent">
                <!-- Modal Header -->
                <div class="flex justify-between items-center px-4 sm:px-6 py-4 border-b bg-white sticky top-0 z-10">
                    <h3 class="text-lg font-semibold text-gray-700">Edit Kronologi</h3>
                    <button id="closeEditModal" class="text-gray-400 hover:text-gray-600 text-2xl leading-none p-1 rounded-full hover:bg-gray-100 transition-colors">
                        &times;
                    </button>
                </div>
                    ...
                    <div class="bg-white border border-gray-200 rounded-lg p-4 shadow-sm mobile-card">
                        <div class="flex justify-between items-start mb-3">
                            ...
                            <div class="flex space-x-2">
                                ...
                                <button class="text-red-500 hover:text-red-700 text-sm font-medium" onclick="confirm('Are you sure?') ? alert('Delete functionality') : ''">
                                    Delete
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-3 text-xs">
                            ...
                            <div>
                                ...
                                <span class="inline-block px-2 py-1 bg-green-100 text-green-800 rounded-full text-xs font-medium">{{ $row->status }}</span>
                            </div>
                        </div>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3 text-sm text-center">
                                    <div class="flex justify-center space-x-2">
                                        ...
                                        <button class="text-red-500 hover:text-red-700 font-medium" onclick="confirm('Are you sure?') ? alert('Delete functionality') : ''">
                                            Delete
                                        </button>
                                    </div>
                                </td>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        const table = document.getElementById('kronologiTable');
        if (table) {
            new DataTable(table, {
                perPage: 10,
