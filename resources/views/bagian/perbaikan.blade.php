...
@section('page-title', ucfirst($bagian) . ' Form')
    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden">
        ...
        <div class="px-6 py-4">
            ...
            <form action="{{ $action }}" method="POST" class="space-y-4">
                ...
                <div class="grid grid-cols-3 gap-2">
                    ...
                    <div>
                        ...
                        <input type="number" id="direct" name="direct"
                            value="{{ old('direct', $item->qty_direct_rosset ?? '') }}"
                            class="w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 text-sm" required>
                    </div>
                </div>
                ...
                {{-- ket reject rework --}}
                <h4 class="font-semibold text-slate-900 mt-3">Keterangan Reject & Rework</h4>
                <div class="grid grid-cols-2 gap-2">
                    <div>
                        <label for="ket_reject" class="block text-sm font-medium text-gray-700 mb-1">Keterangan Reject</label>
                        <textarea name="ket_reject" id="ket_reject" rows="3"
                            class="w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 text-sm">{{ old('ket_reject', $item->ket_reject ?? '') }}</textarea>
                    </div>
                    <div>
                        <label for="ket_rework" class="block text-sm font-medium text-gray-700 mb-1">Keterangan Rework</label>
                        <textarea name="ket_rework" id="ket_rework" rows="3"
                            class="w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 text-sm">{{ old('ket_rework', $item->ket_rework ?? '') }}</textarea>
                    </div>
                </div>
                {{-- Total Mesin --}}
